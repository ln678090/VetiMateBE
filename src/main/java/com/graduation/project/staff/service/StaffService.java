...
public interface StaffService {
  ...
  StaffResponse create(CreateStaffRequest request, UUID actorUserId);

  StaffResponse update(UUID staffId, UpdateStaffRequest request, UUID actorUserId);
  ...
  StaffResponse deactivate(UUID staffId, String reason, UUID actorUserId);

  Page<EligibleUserResponse> searchEligibleUsers(String keyword, Pageable pageable);
}
