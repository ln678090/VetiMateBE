...
public class InventoryController {
  ...
  public ApiResp<StockVoucherResp> createImportVoucher(
      @Valid @RequestBody CreateImportVoucherReq req, @AuthenticationPrincipal Jwt jwt) {
    // Hack: Normally user.getStaff().getId() would be used. Assuming Staff ID = User ID for testing
    // if no staff found.
