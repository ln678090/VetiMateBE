...
public class PetManagementController {
  ...
  public ApiResp<Page<PetManagementSummary>> search(
      ...
      Pageable pageable) {
    return ApiResp
        .<Page<PetManagementSummary>>builder()
        .message("Lấy danh sách thú cưng thành công")
        .data(petManagementService.search(
            keyword,
            species,
            deleted,
            customerId,
  ...
  @GetMapping("/{petId}")
  @PreAuthorize(READ_AUTHORITIES)
  public ApiResp<PetManagementSummary> getById(
      @PathVariable UUID petId) {
    return ApiResp
        .<PetManagementSummary>builder()
  ...
  public ApiResp<PetManagementSummary> create(
      @Valid @RequestBody ManagementPetRequest request) {
    return ApiResp
        .<PetManagementSummary>builder()
  ...
  public ApiResp<PetManagementSummary> update(
    ...
    return ApiResp
        ...
        .data(petManagementService.update(
            petId,
            request))
        .build();
  }
  ...
  @DeleteMapping("/{petId}")
  @PreAuthorize(WRITE_AUTHORITIES)
  public ApiResp<Void> softDelete(
      @PathVariable UUID petId) {
  ...
  @PreAuthorize(WRITE_AUTHORITIES)
  public ApiResp<PetManagementSummary> restore(
      @PathVariable UUID petId) {
    return ApiResp
        .<PetManagementSummary>builder()
