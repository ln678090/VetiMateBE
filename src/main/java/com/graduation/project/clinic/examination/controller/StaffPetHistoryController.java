...
public class StaffPetHistoryController {
  ...
  public ApiResp<List<AppointmentStatusResponse>> getAppointmentStatuses(
    ...
    List<AppointmentStatusResponse> statuses = staffPetHistoryService
    ...
    return ApiResp
        ...
        .message(
            "Lấy trạng thái lịch khám thành công")
        .data(statuses)
        .build();
  }
  ...
  public ApiResp<Page<VisitHistoryResponse>> getCompletedHistory(
      ...
      @PathVariable UUID petId,
      Pageable pageable) {
    Page<VisitHistoryResponse> history = staffPetHistoryService
        .getCompletedHistory(
            customerId,
            petId,
            pageable);
