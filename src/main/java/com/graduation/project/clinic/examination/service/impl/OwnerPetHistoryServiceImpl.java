...
public class OwnerPetHistoryServiceImpl
    implements OwnerPetHistoryService {
  ...
  private AppointmentStatusResponse toAppointmentStatusResponse(
  ...
  private VisitHistoryResponse toVisitHistoryResponse(
      MedicalRecord medicalRecord) {
    Appointment appointment = medicalRecord.getAppointment();

    String doctorName = medicalRecord.getDoctor() == null
        ? "Chưa cập nhật"
        : medicalRecord.getDoctor().getFullName();

    String healthStatus = medicalRecord.getHealthStatus() == null
        ? null
        : medicalRecord.getHealthStatus().name();
